...
const COLLECTION_RULES = Object.freeze({
  ...
  counters: Object.freeze({ pattern: /^counter-[A-Za-z0-9_-]{1,232}$/ }),
  classes: Object.freeze({ pattern: /^class-[A-Za-z0-9_-]{1,234}$/ }),
  "todo-lists": Object.freeze({ pattern: /^todo-[A-Za-z0-9_-]{1,235}$/ }),
  "stopwatch-settings": Object.freeze({ fixedIds: new Set(["current"]) }),
  "stopwatch-records": Object.freeze({ pattern: /^stopwatch-[A-Za-z0-9_-]{1,230}$/ }),
  "streak-preferences": Object.freeze({ fixedIds: new Set(["current"]) }),
